            ...
            <svg class="ico" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257
                   ...
                   0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 7V5z"/>
            </svg>
            +33 751 543 929
          </li>
          <li>
            ...
            <a href="mailto:sabir-bertit@hotmail.fr">sabir-bertit@hotmail.fr</a>
          </li>
          <li>
            <svg class="ico" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
const contactBarComponent = new ContactBarComponent();
